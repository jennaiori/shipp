...
if pyo_solver == 'none':
    ...
    os =  solve_lp_sparse(price_dam, prod, prod_null, stor, stor_null, discount_rate, n_year, p_max, n, p_min = p_min)
else:
    ...
    os =  solve_lp_pyomo(price_dam, prod, prod_null, stor, stor_null, discount_rate, n_year, p_max, n, p_min = p_min, options=dict(name_solver=pyo_solver))
